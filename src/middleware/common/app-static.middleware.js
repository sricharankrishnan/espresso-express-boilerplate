...
module.exports = (app) => {
  ...
  /* paths */
  const htmlFilePath = path.join(`${__base}/src/static/views`);
  const cssFilePath = path.join(`${__base}/src/static/css`);
  const jsFilePath = path.join(`${__base}/src/static/scripts`);
  const assetsFilePath = path.join(`${__base}/src/static/assets`);
  const publicFilesPath = path.join(`${__base}/src/public`);
